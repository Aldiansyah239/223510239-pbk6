    ...
    <q-header flat>
      <q-toolbar>
        <q-toolbar-title style="display: flex; align-items: center;">
          <p  height="40" style="margin-right: auto;">ALDI</p>
        </q-toolbar-title>
    ...
    <q-page-container>
      <q-page padding>
        <q-form @submit.prevent="save" class="q-gutter-md">
          <q-input filled v-model="form.title" label="Judul" />
          <q-input filled v-model="form.content" label="Konten" type="textarea" />
